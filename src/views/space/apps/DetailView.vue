      ...
      <div class="flex flex-col w-1/3 bg-white h-full">
        ...
        <div class="h-full min-h-0 px-6 py-7 overflow-x-hidden overflow-y-scroll scrollbar-w-none">
          <div class="flex flex-row gap-2 mb-6" v-for="message in messages" :key="message.content">
            ...
            <a-avatar v-else :style="{ backgroundColor: '#00d0b6' }" :size="30" class="shrink-0">
              <icon-apps />
            </a-avatar>
            <div class="flex flex-col gap-2">
              <div class="font-semibold text-gray-700">
                {{ message.role === 'human' ? 'W' : 'ChatGPT聊天机器人' }}
              </div>
              <div
                v-if="message.role === 'human'"
          ...
          <!--            <a-avatar :style="{ backgroundColor: '#00d0b6' }" class="shrink-0" :size="30">-->
          <!--              <icon-apps />-->
          <!--            </a-avatar>-->
          <!--            <div class="flex flex-col gap-2">-->
        ...
        <div class="w-full shrink-0 flex flex-col">
          <div class="px-6 flex items-center gap-4">
            <a-button class="shrink-0" type="text" shape="circle" @click="clearMessage">
              <template #icon>
